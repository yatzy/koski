...
object ExamplesPerusopetukseenValmistavaOpetus {
  ...
  val examples = List(Example("perusopetukseen valmistava opetus", "Oppija on suorittanut perusopetukseen valmistavan opetuksen", Oppija(MockOppijat.koululainen.toHenkilötiedotJaOid, List(perusopetukseenValmistavaOpiskeluoikeus))))
}
